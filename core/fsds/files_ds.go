...
// TODO: Speed up Get to not always make request to API but use cache sometimes
...
func (f *filesDataSource) Get(ctx context.Context, path string) (*DirEntry, error) {
	...
	// TODO: Verify service.OpenFile() logic to ensure that multiple open file doesn't
	// recreate multiple local copies for the same file without cleanup
